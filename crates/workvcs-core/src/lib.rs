...
pub use history::{
    ...
    EntityTransitionOptions, GoalCreateCommit, GoalCreateOptions, GoalSnapshot, GoalState,
    GoalStatus, GoalTransitionCommit, GoalTransitionOptions, HistoryEntry, HistoryQueryOptions,
    HistoryQueryResult, HistoryStart, IntegrityReport, PlanCreateCommit, PlanCreateOptions,
    ...
    PrimaryContainmentEndpointKind, PrimaryContainmentSnapshot, ReplayedState,
