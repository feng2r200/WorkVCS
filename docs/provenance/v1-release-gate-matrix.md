...
The source-state basis at the start of Phase 4OT was main commit
`846193310d759410b697aa6970eb1e93c38ca21d` and the V1 readiness ledger last
refreshed by Phase 4OS nested Plan Context Resource probe. Historical
...
selects that runnable prerequisite with the same recovery path.
