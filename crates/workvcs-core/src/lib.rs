...
pub use history::{
    ...
    EntityTransitionOptions, EntityVersionDiff, GoalCreateCommit, GoalCreateOptions, GoalSnapshot,
    GoalState, GoalStatus, GoalTransitionCommit, GoalTransitionOptions, HistoryEntry,
    HistoryQueryOptions, HistoryQueryResult, HistoryStart, IntegrityReport, PlanCreateCommit,
    ...
    PrimaryContainmentEndpointKind, PrimaryContainmentSnapshot, RelationVersionDiff, ReplayedState,
    ResolvedWhyQueryTarget, ResolvedWorkStateDiffTarget, StructuralReferenceCreateCommit,
    ...
    VerificationSnapshot, VerificationState, VerificationTarget, WhyDeferredRelationFamily,
    WhyEntityKind, WhyQueryOptions, WhyQueryResult, WhyQueryTarget, WhyRelationDirection,
    WhyRelationEdge, WhyRelationKind, WorkStateDiff, WorkStateDiffChangeKind, WorkStateDiffOptions,
