...
pub use history::{
    ...
    BundleImportPreflightResult, BundleKnowledgeExposureLocalSourceRef, BundleKnowledgeExposureRef,
    ...
    EvidenceCreateOptions, EvidenceCreateResult, EvidenceSnapshot, ExternalObjectRefListOptions,
