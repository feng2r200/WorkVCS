...
The source-state basis at the start of Phase 4OQ was main commit
`86524a204fc5239277086455fd73c7fa85e5efef` and the V1 readiness ledger last
refreshed by Phase 4OP Plan-start Context Resource probe. Historical
...
surfaces the same recovery path for a direct Goal-to-Plan-to-Task shape.
