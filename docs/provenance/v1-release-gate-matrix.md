...
Last refreshed: 2026-09-03 by ADR-0490 / Phase 4NY
...
The source-state basis at the start of Phase 4NY was main commit
`7eb9fb5798dbf4b80bafd0ea490bff2b875b8323` and the V1 readiness ledger last
refreshed by ADR-0489 / Phase 4NX. Historical governance Plans and logs are
...
Evidence endpoints, plus direct `knowledge_exposure_derived_from` relation
create endpoint evolution projection for queried source Knowledge and target
KnowledgeExposure endpoints. It does not close the remaining full
