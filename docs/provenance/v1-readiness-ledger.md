...
Phase 4ON adds no new release-state claim; it records Phase 4OM read-only
Goal-start recovery evidence after the direct Plan-to-Task Resource-backed
`why` closure implementation while the release gate matrix remains false.
