...
The source-state basis at the start of Phase 4OS was main commit
`9c36b0e4f5eb9f1ace244765036ba930f95022d2` and the V1 readiness ledger last
refreshed by Phase 4OR Goal-start multi-Plan Context Resource probe. Historical
