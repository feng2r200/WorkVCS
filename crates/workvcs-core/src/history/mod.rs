...
pub use checkpoint::{
    CheckpointCreateOptions, CheckpointCreateResult, CheckpointSnapshot, CheckpointValidationResult,
};
pub use containment::{
...
pub(crate) use checkpoint::{checkpoint, create_checkpoint, validate_checkpoint};
