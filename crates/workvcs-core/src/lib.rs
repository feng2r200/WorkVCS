...
pub use history::{
    ...
    WhyCausalAnchorChangeSet, WhyDeferredRelationFamily, WhyEntityKind, WhyQueryOptions,
    WhyQueryResult, WhyQuerySubject, WhyQueryTarget, WhyRelationDirection, WhyRelationEdge,
    WhyRelationEndpoint, WhyRelationKind, WhyScopeLink, WhyScopeLinkKind, WorkStateDiff,
