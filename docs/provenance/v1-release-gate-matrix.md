...
The source-state basis at the start of Phase 4OU was main commit
`92b0e5c2424fe87e3cc5a573386a8c721b2221c0` and the V1 readiness ledger last
refreshed by Phase 4OT cross-Goal dependency Context Resource probe. Historical
...
public CLI flag, `why`, runnable, or `claim next` semantic changes.
...
the bounded direct reference Task shape, broader causal traversal, or
