...
Last refreshed: 2026-09-03 by ADR-0487 / Phase 4NV
...
The source-state basis at the start of Phase 4NV was main commit
`85c3634ee16f5e188fa83a64cdaa203a03cbb9e1` and the V1 readiness ledger last
refreshed by ADR-0486 / Phase 4NU. Historical governance Plans and logs are
...
Verification Requirement endpoints. It
does not close the remaining full relation-subject traversal beyond those
direct endpoint slices, multi-hop/full evolution traversal, broader
context/Resource resolver, broader causal traversal, `evidenced_by` endpoint
evolution, or release-operation gaps named by the gates.
