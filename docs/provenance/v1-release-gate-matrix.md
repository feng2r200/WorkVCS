...
Last refreshed: 2026-09-02 by ADR-0484 / Phase 4NQ
...
The source-state basis at the start of Phase 4NQ was main commit
`f2ffcb1011b3026ade7c9ddc442115bb93816b0d` and the V1 readiness ledger last
refreshed by ADR-0483 / Phase 4NP. Historical governance Plans and logs are
...
`depends_on` and `ordered_before`. It does not close the remaining full
relation-subject traversal beyond those direct endpoint slices, multi-hop/full
evolution traversal, broader context/Resource resolver, broader causal
traversal, or
