...
pub use history::{
    ...
    EntityVersionDiff, EventListOptions, EventListResult, EventListTarget, EventSnapshot,
    ...
    ExternalObjectReferenceScope, GoalCreateCommit, GoalCreateOptions, GoalSnapshot, GoalState,
    GoalStatus, GoalTransitionCommit, GoalTransitionOptions, HistoryEntry, HistoryQueryOptions,
    HistoryQueryResult, HistoryStart, IntegrityReport, KnowledgeCreateCommit,
