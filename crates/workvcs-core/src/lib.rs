...
pub use history::{
    ...
    WhyEvolutionChangeOperation, WhyQueryOptions, WhyQueryResult, WhyQuerySubject, WhyQueryTarget,
    WhyRelationDirection, WhyRelationEdge, WhyRelationEndpoint, WhyRelationKind, WhyScopeLink,
    WhyScopeLinkKind, WorkStateDiff, WorkStateDiffChangeKind, WorkStateDiffOptions,
