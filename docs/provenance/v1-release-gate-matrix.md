...
Last refreshed: 2026-09-02 by ADR-0478 / Phase 4NK
...
The source-state basis at the start of Phase 4NK was main commit
`7a4ad9fa00d3ac96a80b2124eca222b605146e6f` and the V1 readiness ledger last
refreshed by ADR-0477 / Phase 4NJ. Historical governance Plans and logs are
...
maturity proof, direct queried-Entity evolution operation projection, and
operation-local direct Entity evolution detail for `workvcs why`. It does not
close the remaining relation-subject traversal, multi-hop/full evolution
