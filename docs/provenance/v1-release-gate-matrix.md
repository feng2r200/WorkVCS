...
Last refreshed: 2026-09-03 by ADR-0488 / Phase 4NW
...
The source-state basis at the start of Phase 4NW was main commit
`1bcc48ec9d729c642232d7b6d552dce2d9a6f87a` and the V1 readiness ledger last
refreshed by ADR-0487 / Phase 4NV. Historical governance Plans and logs are
...
peer Tasks when focus is a Task, plus direct `verifies` relation create endpoint
evolution projection for queried Verification, Acceptance Criterion, and
Verification Requirement endpoints, plus direct `evidenced_by` relation create
endpoint evolution projection for queried Verification endpoints. It does not
close the remaining full relation-subject traversal beyond those direct
endpoint slices, multi-hop/full evolution traversal, broader context/Resource
resolver, broader causal traversal, or release-operation gaps named by the
gates.
