...
Last refreshed: 2026-09-01 by ADR-0427 / Phase 4LL
...
| Context resolver | Yes | Partial | Yes | Partial | Phase 4LL adds brief Goal/Plan path packet items from current primary containment; complete remaining V1 categories: Attempt details, path-sensitive Knowledge policy, and packet persistence. |
...
- Current smoke Stores are temporary and scripted. Phase 4KX adds a local
  ...
  packet output. WorkVCS has still not been used for another real project.
