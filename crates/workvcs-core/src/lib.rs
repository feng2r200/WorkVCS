...
pub use history::{
    ...
    ChangeOperationSubject, ChangeSetCommitSnapshot, ChangeSetSnapshot, CheckpointCreateOptions,
    CheckpointCreateResult, CheckpointLatestOptions, CheckpointLatestResult, CheckpointListOptions,
    CheckpointListResult, CheckpointSnapshot, CheckpointValidationResult, CommitParentSnapshot,
    CommitSnapshot, DecisionRecordSupersedeCommit, DecisionRecordSupersedeOptions,
    EntityTransitionCommit, EntityTransitionOptions, EntityVersionDiff, EventListOptions,
    EventListResult, EventListTarget, EventSnapshot, EvidenceContentInput, EvidenceContentSnapshot,
