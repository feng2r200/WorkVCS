...
pub use history::{
    ...
    EntityTransitionCommit, EntityTransitionOptions, EntityVersionDiff, EvidenceContentInput,
    EvidenceContentSnapshot, EvidenceCreateOptions, EvidenceCreateResult, EvidenceSnapshot,
    ...
    IntegrityReport, KnowledgeCreateCommit, KnowledgeCreateOptions, KnowledgeListOptions,
    ...
    KnowledgeRelationRestoreOptions, KnowledgeRelationSnapshot, KnowledgeSnapshot, KnowledgeState,
