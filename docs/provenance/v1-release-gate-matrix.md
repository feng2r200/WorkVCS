...
The source-state basis at the start of Phase 4OP was main commit
`4cff7acd4b0e5e43c720d9bfbc2b10f9bd63ac61` and the V1 readiness ledger last
refreshed by Phase 4ON / Phase 4OM evidence refresh. Historical governance Plans and logs are
...
`claim next --context-profile full` preserves that recovery path.
