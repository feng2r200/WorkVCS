...
The source-state basis at the start of Phase 4OW was main commit
`33d28ba6a417a44e67ae6851de565aa2af52ac07` and the V1 readiness ledger last
refreshed by Phase 4OV structural-reference Plan target Context Resource
recovery. Historical
...
runnable, or `claim next` semantic changes.
...
the one-level referenced-Plan nested child Task shape, broader causal
traversal, or release-operation gaps named by the gates.
