...
Last refreshed: 2026-09-03 by ADR-0489 / Phase 4NX
...
The source-state basis at the start of Phase 4NX was main commit
`c7917482d5fde79aa5c7cb085c86054a453b0a94` and the V1 readiness ledger last
refreshed by ADR-0488 / Phase 4NW. Historical governance Plans and logs are
...
endpoint evolution projection for queried Verification endpoints and queried
Evidence endpoints. It does not close the remaining full relation-subject
traversal beyond those direct endpoint slices, multi-hop/full evolution
