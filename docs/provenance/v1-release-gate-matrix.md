...
Last refreshed: 2026-09-02 by ADR-0485 / Phase 4NR
...
The source-state basis at the start of Phase 4NR was main commit
`75e6c5e82238dc5a7824ef802d2980995f0fe716` and the V1 readiness ledger last
refreshed by ADR-0484 / Phase 4NQ. Historical governance Plans and logs are
...
`depends_on` and `ordered_before`, and direct primary containment create
endpoint evolution projection for queried Goal, Plan, and Task endpoints. It
